...
class TeamsManagementPopup extends Component {
    ...
    handleSubmit() {
        ...
        store.dispatch( addTeam( teamName, teamColor ) )
        .then(() => {
            this.setState({ addModeFlag: false })
        })
    }
        ...
        if ( this.state.addModeFlag ) {
                ...
                <div>
                    ...
                    <div className = 'popup__content'>
                        ...
                        <div className = 'popup__input-wrapper'>
                            ...
                            <input className = 'popup__input' ref = 'colorInput' placeholder = 'na przykład: orange, #332211, rgb(66, 134, 244)'/>
                        </div>
                    </div>
            ...
            structure = 
                <div>
                    ...
                    <div className = 'popup__cta'>
                        <button className = 'popup__button' onClick = { this.handleAdd }>Dodaj zespół</button>
                    </div>
                </div> 
        }
