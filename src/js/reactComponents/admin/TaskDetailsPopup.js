...
class TaskDetailsPopup extends Component {
    ...
    handleSubmit() {
        ...
        store.dispatch( updateTask( taskObj, this.props.taskDetails.id, this.props.cellId, this.props.weekNum, this.props.year ) )
        .then(() => {
                ...
                <div>
                    ...
                    <div className = 'popup__content'>
                        <div className = 'popup__input-wrapper'>
                            ...
                            <select className = 'popup__input' ref = 'typeInput' defaultValue = { this.props.taskDetails.type }>
                        ...
                        <div className = 'popup__input-wrapper'>
                            ...
                            <input className = 'popup__input' ref = 'nameInput' defaultValue = { this.props.taskDetails.name }/>
                        </div>
                        <div className = 'popup__input-wrapper'>
                            <label className = 'popup__label'>Opis zadania:</label>
                            <input className = 'popup__input' ref = 'descriptionInput' defaultValue = { this.props.taskDetails.description }/>
                        </div>
                        <div className = 'popup__input-wrapper'>
                            <label className = 'popup__label'>Link do Active Collab:</label>
                            <input className = 'popup__input' ref = 'linkInput' defaultValue = { this.props.taskDetails.link }/>
                        </div>
                    </div>
            ...
            structure = 
                <div>
                    ...
                    <div className = 'popup__content'>
                        ...
                        <h5>Link do Active Collab:</h5>
                        <p><a href = { this.props.taskDetails.link } target = '_blank'>{ this.props.taskDetails.link }</a></p>
                    </div>
