...
export default class SingleTeam extends Component {
  ...
  handleSubmit() {
    ...
    store.dispatch(updateTeam(teamObj, this.props.teamInfo.id)).then(() => {
  ...
  render() {
        ...
        <div>
          <div className="popup__input-wrapper">
            ...
            <input
              ...
              ref="teamInput"
              defaultValue={this.props.teamInfo.name}
            />
          </div>
          <div className="popup__input-wrapper">
            ...
            <input
              className="popup__input"
              ref="colorInput"
              defaultValue={this.props.teamInfo.color}
            />
          </div>
      ...
      structure = (
        <div className="flex-container--align-center flex-container--space-between">
          <div className="flex-container--align-center">
            <div
              style={{ backgroundColor: this.props.teamInfo.color }}
          ...
          <div>
            ...
            <button className="popup__button" onClick={this.handleTeamDelete}>
              Usuń
            </button>
          </div>
        </div>
    ...
    return <div className="popup__list-item">{structure}</div>;
  }
}
