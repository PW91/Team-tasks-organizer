...
class UserDetailsPopup extends Component {
    ...
    handleSubmit() {
        ...
        store.dispatch( updateUser( userObj, this.props.userInfo.id ) )
        .then(() => {
            this.setState({ editModeFlag: false })
        })
    }
            ...
            structure = 
                <div>
                    ...
                    <div className = 'popup__content'>
                        ...
                        <input className = 'popup__input' ref = 'userNameInput' defaultValue = { this.props.userInfo.name }/>
                        </div>
                        <div className = 'popup__input-wrapper'>
                        <label className = 'popup__label'>Nazwisko:</label>
                        <input className = 'popup__input' ref = 'userSurnameInput' defaultValue = { this.props.userInfo.surname }/>
                        </div>
                        <div className = 'popup__input-wrapper'>
                        <label className = 'popup__label'>Pozycja:</label>
                        <input className = 'popup__input' ref = 'userPositionInput' defaultValue = { this.props.userInfo.position }/>
                        </div>
                        <div className = 'popup__input-wrapper'>
                        <label className = 'popup__label'>Zespół:</label>
                            <select className = 'popup__input' ref = 'userTeamInput' defaultValue = { this.props.userInfo.team }>
